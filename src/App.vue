...
export default {
	...
	components: {
		// Lazyload the components that are not initially
		Sidebar: () => import(/* webpackPrefetch: true */ '@/components/layout/Sidebar'),
		Messagebar: () => import(/* webpackPrefetch: true */'@/components/layout/Messagebar'),
		Cooper: () => import(/* webpackPrefetch: true */'@/components/fragments/Cooper'),
		ColorRgbBar,
		Toolbar,
		Footer,
		ColorHexBar,
